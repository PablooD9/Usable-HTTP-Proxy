        ...
        J.VERSION = "1.13.9", J.DEFAULTS = {
            ...
            render: function() {
                ...
                if (this.togglePlaceholder(), this.tabIndex(), "static" === this.options.selectedTextFormat) a = Y({
                    ...
                    var elementEnglish = document.getElementsByClassName("language-icon icon-en");
                    var textToShow = (elementEnglish[0] != undefined) ? "Varias opciones seleccionadas..." : "Several options selected...";
                    2 <= n && a.appendChild(document.createTextNode(textToShow))
                } else {
