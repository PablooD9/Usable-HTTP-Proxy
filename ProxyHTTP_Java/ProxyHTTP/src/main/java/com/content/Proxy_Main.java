...
/** Clase encargada de crear un manejador de peticiones por cada petici�n recibida
 * @author Pablo
 *
 */
public class Proxy_Main extends Thread {
    ...
    public void run() {
    	try {
			...
			Socket socket;
	    	try {
	    		// Cuando haya una conexi�n abierta en el socket servidor, la abrimos/aceptamos y la manejamos.
